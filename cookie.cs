...
public class CreateAssessmentSample
{
    ...
    public void createAssessment(string projectID = "cerez-uygulamasi-1722512841859", string recaptchaKey = "6LfxKh0qAAAAAPkl6ItTC089DQ9ir5Em5_RYs5Mm", string token = "action-token", string recaptchaAction = "action-name")
    {
